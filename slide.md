...
- [`ffmpeg`](https://ffmpeg.org/), [`pandoc`](https://pandoc.org/), [`jq`](https://stedolan.github.io/jq/), [`yq`](https://github.com/kislyuk/yq)
- [`yt-dlp`](https://github.com/yt-dlp/yt-dlp), [`instaloader`](https://instaloader.github.io/), [`spotdl`](https://github.com/spotDL/spotify-downloader), [`spotify-tui`](https://github.com/Rigellute/spotify-tui), [`trans`](https://github.com/soimort/translate-shell)
